...
const Root = async () => (
  <div className="s8-page s8-page-root">
    ...
    <main className="s8-page-main s8-page-root-main md:grid md:grid-cols-2">
      ...
      <ul className="md:mt-20 mb-10">
        <li className="mb-3">
          ...
          <p>
            Developer experience is as important as user experience. The
            developer is the first user.
          </p>
        </li>
        <li className="mb-3">
          ...
          <p>
            ...
            animation, and anything else a browser can render. Every article is
            an app, and vice versa. Code is a creative medium for storytelling.
          </p>
        </li>
        <li>
          ...
          <p>
            ...
            <Link href="https://vercel.com">Vercel</Link> app, a Docker
            container, or <Link href="https://kubernetes.io">Kubernetes</Link>{' '}
            Deployment. It means open standards, like RSS, and soon,{' '}
